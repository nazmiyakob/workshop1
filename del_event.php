...
<center>
    ...
    <?php 
      ...
      <tr bgcolor='lightyellow'>
        ...
        <th><center> QUANTITY OF TICKET </center></th>
...
<input type='hidden' name='deletecart' value='$EventId' />

<form action='' method='POST'><td align='center'>&nbsp;" . "<button type='submit' span='2' formaction='del_eventP.php?EventId=".$query2['EventId']."'>DELETE</button></form>";
